...
export function CaseStudyDialog({
  ...
  const imageSource = caseStudy.imageUrl || caseStudy.image || "/placeholder.svg"
  ...
  return (
    <Card className="flex flex-col h-full overflow-hidden">
      <div className="aspect-video relative">
        <Image src={imageSource || "/placeholder.svg"} alt={caseStudy.title} fill className="object-cover" />
      </div>
